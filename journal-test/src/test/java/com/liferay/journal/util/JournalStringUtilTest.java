...
public class JournalStringUtilTest {
	...
	public void testClosedTags() {
		...
		Assert.assertEquals(
			"<div>123456789</div>",
			JournalStringUtil.shortenWithHtml(string, 20));

		Assert.assertEquals(
			"<div>123456789</div>",
			JournalStringUtil.shortenWithHtml(string, 14));
	...
	public void testManyUnclosedTags() {
		...
		Assert.assertEquals(
			"<a><b><i>123456789</a></b>",
			JournalStringUtil.shortenWithHtml(string, 26));
	...
	public void testNoOpenTag() {
		...
		Assert.assertEquals(
			"12345</p>abc", JournalStringUtil.shortenWithHtml(string, 15));
	...
	public void testUnclosedTags() {
		...
		Assert.assertEquals(
			"<div>123456789", JournalStringUtil.shortenWithHtml(string, 14));

		Assert.assertEquals(
			"<div>123456789", JournalStringUtil.shortenWithHtml(string, 20));
	}
